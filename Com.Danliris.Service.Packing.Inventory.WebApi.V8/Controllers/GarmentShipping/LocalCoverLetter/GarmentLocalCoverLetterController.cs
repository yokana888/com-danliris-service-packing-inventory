...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.Controllers.GarmentShipping.GarmentLocalCoverLetter
{
    [Produces("application/json")]
    [Route("v1/garment-shipping/local-cover-letters")]
    [Authorize]
    public class GarmentLocalCoverLetterController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] GarmentLocalCoverLetterViewModel viewModel)
        {
            try
            {
                VerifyUser();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put([FromRoute] int id, [FromBody] GarmentLocalCoverLetterViewModel viewModel)
        {
            try
            {
                VerifyUser();
