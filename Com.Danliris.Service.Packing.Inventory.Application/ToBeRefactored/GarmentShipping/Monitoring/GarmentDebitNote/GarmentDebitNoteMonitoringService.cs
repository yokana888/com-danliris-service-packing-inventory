        ...
        public MemoryStream GenerateExcel(string buyerAgent, DateTime? dateFrom, DateTime? dateTo, int offset)
       {
            ...
            else
            {
                ...
                foreach (var d in Query)
                {
                    ...
                    string NoteDate = d.DNDate == new DateTime(1970, 1, 1) ? "-" : d.DNDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
        ...
        public MemoryStream GenerateExcelMII(DateTime? dateFrom, DateTime? dateTo, int offset)
        {
            ...
            else
            {
                ...
                foreach (var d in Query)
                {
                    ...
                    string DNTgl = d.DNDate == new DateTime(1970, 1, 1) ? "-" : d.DNDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
