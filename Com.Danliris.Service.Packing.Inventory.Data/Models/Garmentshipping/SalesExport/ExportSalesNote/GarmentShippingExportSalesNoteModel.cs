...
{
    public class GarmentShippingExportSalesNoteModel : StandardEntity
    {
        ...
        public ICollection<GarmentShippingExportSalesNoteItemModel> Items { get; private set; }

        public GarmentShippingExportSalesNoteModel()
        {
        }

        public GarmentShippingExportSalesNoteModel(string salesContractNo, int exportSalesContractId, string paymentType, string noteNo, DateTimeOffset date, int transactionTypeId, string transactionTypeCode, string transactionTypeName, int buyerId, string buyerCode, string buyerName, string buyerNPWP, string kaberType, int tempo, string expenditureNo, string dispositionNo, bool useVat, int vatId, int vatRate, string remark, bool isUsed, bool isApproveShipping, bool isApproveFinance, string approveShippingBy, string approveFinanceBy, DateTimeOffset approveShippingDate, DateTimeOffset approveFinanceDate, bool isRejectedShipping, bool isRejectedFinance, string rejectedReason, int bankId, string bankName, string accountNumber, ICollection<GarmentShippingExportSalesNoteItemModel> items)
        {
            SalesContractNo = salesContractNo;
            ExportSalesContractId = exportSalesContractId;
            NoteNo = noteNo;
            Date = date;
