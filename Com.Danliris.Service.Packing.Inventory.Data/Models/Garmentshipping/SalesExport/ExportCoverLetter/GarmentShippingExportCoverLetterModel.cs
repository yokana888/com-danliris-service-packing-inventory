...
namespace Com.Danliris.Service.Packing.Inventory.Data.Models.Garmentshipping.SalesExport.ExportCoverLetter
{
    public class GarmentShippingExportCoverLetterModel : StandardEntity
    {
        public int ExportSalesNoteId { get; private set; }
        public string? NoteNo { get; private set; }
        public string? ExportCoverLetterNo { get; private set; }
        ...
        public GarmentShippingExportCoverLetterModel()
        {
        }

        public GarmentShippingExportCoverLetterModel(int exportSalesNoteId, string noteNo, string exportCoverLetterNo, DateTimeOffset date, int buyerId, string buyerCode, string buyerName, string buyerAdddress, string remark, string bcNo, DateTimeOffset bcDate, string truck, string plateNumber, string driver, int shippingStaffId, string shippingStaffName)
        {
            ExportSalesNoteId = exportSalesNoteId;
            NoteNo = noteNo;
            ExportCoverLetterNo = exportCoverLetterNo;
            Date = date;
            BuyerId = buyerId;
            BuyerCode = buyerCode;
            BuyerName = buyerName;
