...
{
    public class GarmentShippingExportSalesContractModel : StandardEntity
    {
        ...
        public ICollection<GarmentShippingExportSalesContractItemModel> Items { get; private set; }

        public GarmentShippingExportSalesContractModel()
        {
        }

        public GarmentShippingExportSalesContractModel(string salesContractNo, DateTimeOffset salesContractDate, int transactionTypeId, string transactionTypeCode, string transactionTypeName, string sellerName, string sellerPosition, string sellerAddress, string sellerNPWP, int buyerId, string buyerCode, string buyerName, string buyerAddress, string buyerNPWP, bool isUseVat, int vatId, int vatRate, decimal subTotal, bool isUsed, ICollection<GarmentShippingExportSalesContractItemModel> items)
        {
