...
{
    public class GarmentShippingExportSalesContractItemModel : StandardEntity
    {
        ...
        public GarmentShippingExportSalesContractItemModel(int productId, string productCode, string productName, double quantity, double remainingQuantity, int uomId, string uomUnit, double price, int comodityId, string comodityCode, string comodityName, string remark)
        {
            ProductId = productId;
        ...
        public GarmentShippingExportSalesContractItemModel()
        {
        }
