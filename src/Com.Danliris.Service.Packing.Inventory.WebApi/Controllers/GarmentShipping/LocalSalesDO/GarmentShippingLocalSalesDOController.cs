...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.V8.Controllers.GarmentShipping.LocalSalesDO
{
    ...
    {
        private readonly IGarmentShippingLocalSalesDOService _service;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] GarmentShippingLocalSalesDOViewModel viewModel)
        {
            try
            {
                VerifyUser();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put([FromRoute] int id, [FromBody] GarmentShippingLocalSalesDOViewModel viewModel)
        {
            try
            {
                VerifyUser();
        ...
        public async Task<IActionResult> GetPDF([FromRoute] int Id)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var PdfTemplate = new GarmentShippingLocalSalesDOPdfTemplate();
