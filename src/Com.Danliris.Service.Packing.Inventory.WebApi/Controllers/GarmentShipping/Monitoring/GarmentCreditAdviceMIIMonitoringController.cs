...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.V8.Controllers.GarmentShipping.Monitoring
{
    ...
    [Route("v1/garment-shipping/monitoring/garment-credit-advice-mii")]
    [Authorize]
    public class GarmentCreditAdviceMIIMonitoringController : ControllerBase
    {
        private string ApiVersion = "1.0.0";
        private readonly IGarmentCreditAdviceMIIMonitoringService _service;
        private readonly IIdentityProvider _identityProvider;

        public GarmentCreditAdviceMIIMonitoringController(IGarmentCreditAdviceMIIMonitoringService service, IIdentityProvider identityProvider)
        {
            _service = service;
        ...
        public IActionResult GetXls(DateTime? dateFrom, DateTime? dateTo)
        {
            try
            {
                ...
                string filename = string.Format("Monitoring Credit Advice MII - {0}.xlsx", DateTime.UtcNow.ToString("ddMMyyyy"));
