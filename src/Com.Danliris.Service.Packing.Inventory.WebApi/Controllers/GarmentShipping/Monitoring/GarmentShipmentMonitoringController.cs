...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.V8.Controllers.GarmentShipping.Monitoring
{
    ...
    [Route("v1/garment-shipping/monitoring/garment-shipment")]
    [Authorize]
    public class GarmentShipmentMonitoringController : ControllerBase
    {
        private string ApiVersion = "1.0.0";
        private readonly IGarmentShipmentMonitoringService _service;
        private readonly IIdentityProvider _identityProvider;

        public GarmentShipmentMonitoringController(IGarmentShipmentMonitoringService service, IIdentityProvider identityProvider)
        {
            _service = service;
