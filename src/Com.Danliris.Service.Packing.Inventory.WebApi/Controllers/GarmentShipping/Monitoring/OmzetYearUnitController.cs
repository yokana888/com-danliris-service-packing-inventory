...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.V8.Controllers.GarmentShipping.Monitoring
{
    ...
    [Route("v1/garment-shipping/monitoring/omzet-year-unit")]
    [Authorize]
    public class OmzetYearUnitController : ControllerBase
    {
        private readonly IOmzetYearUnitService _service;
        private readonly IIdentityProvider _identityProvider;

        public OmzetYearUnitController(IOmzetYearUnitService service, IIdentityProvider identityProvider)
        {
            _service = service;
