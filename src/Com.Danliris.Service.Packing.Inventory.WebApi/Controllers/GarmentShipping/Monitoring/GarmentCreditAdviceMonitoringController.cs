...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.V8.Controllers.GarmentShipping.Monitoring
{
    ...
    [Route("v1/garment-shipping/monitoring/garment-credit-advice")]
    [Authorize]
    public class GarmentCreditAdviceMonitoringController : ControllerBase
    {
        private string ApiVersion = "1.0.0";
        private readonly IGarmentCreditAdviceMonitoringService _service;
        private readonly IIdentityProvider _identityProvider;

        public GarmentCreditAdviceMonitoringController(IGarmentCreditAdviceMonitoringService service, IIdentityProvider identityProvider)
        {
            _service = service;
