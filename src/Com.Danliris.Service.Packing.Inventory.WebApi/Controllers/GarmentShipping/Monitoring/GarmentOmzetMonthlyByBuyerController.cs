...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.V8.Controllers.GarmentShipping.Monitoring
{
    ...
    [Route("v1/garment-shipping/monitoring/garment-omzet-by-buyer")]
    [Authorize]
    public class GarmenOmzetMonthlyByBuyerController : ControllerBase
    {
        private string ApiVersion = "1.0.0";
        private readonly IGarmentOmzetMonthlyByBuyerService _service;
        ...
        public IActionResult GetXls(string buyerAgent, DateTime? dateFrom, DateTime? dateTo)
        {
            try
            {
                ...
                string filename = string.Format("Garment Omzet Per Buyer - {0}.xlsx", DateTime.UtcNow.ToString("ddMMyyyy"));
