...
namespace Com.Danliris.Service.Packing.Inventory.WebApi.V8.Controllers.GarmentShipping.InsuranceDisposition
{
    [Produces("application/json")]
    [Route("v1/garment-shipping/insurance-dispositions")]
    [Authorize]
    public class GarmentShippingInsuranceDispositionController : ControllerBase
    {
        private readonly IGarmentShippingInsuranceDispositionService _service;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] GarmentShippingInsuranceDispositionViewModel viewModel)
        {
            try
            {
                VerifyUser();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put([FromRoute] int id, [FromBody] GarmentShippingInsuranceDispositionViewModel viewModel)
        {
            try
            {
                VerifyUser();
