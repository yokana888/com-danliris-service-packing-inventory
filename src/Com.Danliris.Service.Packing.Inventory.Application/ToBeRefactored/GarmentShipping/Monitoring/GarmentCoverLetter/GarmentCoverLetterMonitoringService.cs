        ...
        {            
            ...
            else
            {
                ...
                foreach (var d in Query)
                {
                    ...
                    string CLDate = d.CLDate == new DateTime(1970, 1, 1) ? "-" : d.CLDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
                    string EstDate = d.ExportDate == new DateTime(1970, 1, 1) ? "-" : d.ExportDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
                    string BookDate = d.BookingDate == new DateTime(1970, 1, 1) ? "-" : d.BookingDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
