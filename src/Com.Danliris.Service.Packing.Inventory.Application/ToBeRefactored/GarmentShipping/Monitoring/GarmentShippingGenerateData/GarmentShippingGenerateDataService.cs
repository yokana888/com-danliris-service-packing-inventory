        ...
        public MemoryStream GenerateExcel(DateTime? dateFrom, DateTime? dateTo, int offset)
        {
            ...
            else
            {
                ...
                foreach (var d in Query)
                {
                    ...
                    string PEBDate = d.PEBDate == new DateTime(1970, 1, 1) ? "-" : d.PEBDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
                    string TruckDate = d.TruckingDate == new DateTime(1970, 1, 1) ? "-" : d.TruckingDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
                    string DueDate = d.DueDate == new DateTime(1970, 1, 1) ? "-" : d.DueDate.AddHours(offset).ToString("MM/dd/yyyy", new CultureInfo("us-US"));
                    string MtUang = "USD";
