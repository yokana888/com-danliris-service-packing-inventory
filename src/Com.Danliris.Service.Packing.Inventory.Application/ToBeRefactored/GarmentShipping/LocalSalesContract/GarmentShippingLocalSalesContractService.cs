...
namespace Com.Danliris.Service.Packing.Inventory.Application.ToBeRefactored.GarmentShipping.LocalSalesContract
{
    public class GarmentShippingLocalSalesContractService : IGarmentShippingLocalSalesContractService
    {
        ...
        private static GarmentShippingLocalSalesContractViewModel MapToViewModel(GarmentShippingLocalSalesContractModel model)
        {
        ...
        public async Task<int> Create(GarmentShippingLocalSalesContractViewModel viewModel)
        {
            ...
            //Add Log History
            await logHistoryRepository.InsertAsync("SHIPPING", "Create Sales Contract Lokal - " + model.SalesContractNo);
        ...
        public async Task<int> Delete(int id)
        {
            ...
            //Add Log History
            await logHistoryRepository.InsertAsync("SHIPPING", "Delete Sales Contract Lokal - " + data.SalesContractNo);
        ...
        public async Task<int> Update(int id, GarmentShippingLocalSalesContractViewModel viewModel)
        {
            ...
            //Add Log History
            await logHistoryRepository.InsertAsync("SHIPPING", "Update Sales Contract Lokal - " + model.SalesContractNo);
