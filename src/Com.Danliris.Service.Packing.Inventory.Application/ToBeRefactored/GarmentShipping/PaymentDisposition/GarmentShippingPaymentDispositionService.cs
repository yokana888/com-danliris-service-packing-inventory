...
namespace Com.Danliris.Service.Packing.Inventory.Application.ToBeRefactored.GarmentShipping.PaymentDisposition
{
    public class GarmentShippingPaymentDispositionService : IGarmentShippingPaymentDispositionService
    {
        ...
        public static GarmentShippingPaymentDispositionViewModel MapToViewModel(GarmentShippingPaymentDispositionModel model)
        {
            var viewModel = new GarmentShippingPaymentDispositionViewModel()
            {
                Active = model.Active,
                Id = model.Id,
