...
namespace Com.Danliris.Service.Packing.Inventory.Application.ToBeRefactored.GarmentShipping.SalesExport
{
    public class GarmentShippingExportSalesContractService : IGarmentShippingExportSalesContractService
    {
        ...
        private static GarmentShippingExportSalesContractViewModel MapToViewModel(GarmentShippingExportSalesContractModel model)
        {
        ...
        public async Task<int> Create(GarmentShippingExportSalesContractViewModel viewModel)
        {
            ...
            //Add Log History
            await logHistoryRepository.InsertAsync("SHIPPING", "Create Sales Contract Export - " + model.SalesContractNo);
        ...
        public async Task<int> Delete(int id)
        {
            ...
            //Add Log History
            await logHistoryRepository.InsertAsync("SHIPPING", "Delete Sales Contract Export - " + data.SalesContractNo);
        ...
        public async Task<int> Update(int id, GarmentShippingExportSalesContractViewModel viewModel)
        {
            ...
            //Add Log History
            await logHistoryRepository.InsertAsync("SHIPPING", "Update Sales Contract Export - " + model.SalesContractNo);
